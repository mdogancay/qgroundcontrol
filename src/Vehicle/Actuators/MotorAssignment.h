...
private:
    static constexpr int _spin_timeout_default_s = 1000;
    static constexpr int _spin_timeout_high_s = 3000; ///< wait a bit longer after assigning motors, so ESCs can initialize
